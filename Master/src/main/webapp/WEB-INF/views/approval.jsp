...
<script type="text/javascript">
	...
	function delappr(id) {
		if (confirm("삭제 하시겠습니까?")) {
			document.location.href="delappr.do?id=" + id;
		}
	}
	function searchA() {
		var search_form_a = document.getElementById("search_form_a");
		
		search_form_a.submit();
	}
	function sh_yearA() {
		var year_form_a = document.getElementById("year_form_a");
...
<div id="main">
	...
	<div id = "wh">
	<h3>승인 내역</h3>
	<form action="sh_year_a.do" method="post" id="year_form_a">
		<select name="year">
	...
	<input type="button" value="검색" class="sh_btn" onclick="sh_yearA();">
	</form>
	<table id = "tab">
	<tr>
		<th class="num">번호</th>
	...
	<form action="search_a.do" method="post" id="search_form_a">
		<select name="month">
		...
		<input type="button" value="검색" class="sh_btn" onclick="searchA();">
	</form>
	</div>
