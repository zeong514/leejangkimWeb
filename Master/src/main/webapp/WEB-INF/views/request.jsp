...
<script type="text/javascript">
	...
	function nextappr(id) {
		if (confirm("승인 하시겠습니까?")) {
			document.location.href="nextappr.do?id=" + id;
		}
	}
	function searchR() {
...
<div id="main">
	...
	<div id = "wh">
	<h3>신청 내역</h3>
	<form action="sh_year.do" method="post" id="year_form">
		<select name="year">
	...
	<input type="button" value="검색" class="sh_btn" onclick="sh_yearR();">
	</form>
	<table id = "tab">
	<tr>
		<th class="num">번호</th>
	...
	<tr>
	    ...
	    <td class="btn"><input type="button" value="승인" class="ok_btn" onclick="nextappr(<%=item.get(i).getRequest().getId() %>);" /></td>
	</tr>
	<%} %>
	</table>
	
	<div style="margin-top: 20px;">
	<form action="search_r.do" method="post" id="search_form">
		<select name="month">
		...
		<input type="button" value="검색" class="sh_btn" onclick="searchR();"/>
	</form>
	</div>
